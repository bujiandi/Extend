...
extension SQLite {
    ...
    public enum ErrorType : Int, CustomStringConvertible, CustomDebugStringConvertible, Error {
...
extension DBError {
    ...
    var type:SQLite.ErrorType {
        return SQLite.ErrorType(rawValue: code) ?? .error
    }
}
