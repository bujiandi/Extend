...
public final class Listener<T> {
    ...
    public func syncObservers(from listener:Listener<T>) {
    ...
    @discardableResult
    public func addNotice<This:AnyObject>(target: This, change: @escaping (ObservedChange<Handler<This, T>, T>) -> Void) -> Notice<T> {
    ...
    @discardableResult
    public func addNotice(target: AnyObject, action: Selector, needRelease:Bool = false) -> Notice<T> {
...
extension Listener {
    ...
    public struct Notice<T> {
        ...
        fileprivate let listener : Listener<T>
        fileprivate let observer : Observer<T>
        
        fileprivate init(_ listener:Listener<T>, _ observer:Observer<T>) {
...
extension Listener {
    ...
    @inline(__always)
    public static postfix func & <T>(listener:Listener<T>) -> T {
...
extension Listener {
    ...
    @inline(__always)
    public static func <- (lhs: Listener<T>, rhs: T) {
        lhs.value = rhs
    }
...
extension Listener : CustomDebugStringConvertible where T : CustomDebugStringConvertible {
    public var debugDescription: String { return value.debugDescription }
}

extension Listener : Costable where T : Costable {
    
    public var cost: Int { return value.cost }
    
}
//
//extension Listener : CaseIterable where T : CaseIterable {
//
//    public typealias AllCases = T.AllCases
//
//    /// A collection of all values of this type.
//    public static var allCases: T.AllCases { return T.allCases }
//}

extension Listener where T == String {
    ...
    @inline(__always)
    public static func += (lhs: inout Listener<String>, rhs: String) {
        lhs.value += rhs
    }
...
extension Listener : Comparable where T : Comparable {
...
extension Listener : Equatable where T : Equatable {
...
extension Listener : Hashable where T : Hashable {
...
extension Listener : Encodable where T : Encodable {
...
extension Listener : Decodable where T : Decodable {
...
extension Listener : RawRepresentable where T : RawRepresentable {
...
extension Listener : ExpressibleByNilLiteral where T : ExpressibleByNilLiteral {
...
extension Listener : ExpressibleByFloatLiteral where T : ExpressibleByFloatLiteral {
...
extension Listener : ExpressibleByIntegerLiteral where T : ExpressibleByIntegerLiteral {
...
extension Listener : ExpressibleByBooleanLiteral where T : ExpressibleByBooleanLiteral {
...
extension Listener : ExpressibleByUnicodeScalarLiteral where T : ExpressibleByUnicodeScalarLiteral {
...
extension Listener : ExpressibleByExtendedGraphemeClusterLiteral where T : ExpressibleByExtendedGraphemeClusterLiteral {
...
extension Listener : ExpressibleByStringLiteral where T : ExpressibleByStringLiteral {
...
extension Listener : ExpressibleByArrayLiteral where T : ExpressibleByArrayLiteral, T : RangeReplaceableCollection, T.ArrayLiteralElement == T.Element {
...
extension Listener : RangeExpression where T : RangeExpression {
...
extension Listener : IteratorProtocol where T : IteratorProtocol {
...
extension Listener : Sequence where T : Sequence {
...
extension Listener : Collection where T : Collection {
...
extension Listener : MutableCollection where T : MutableCollection {
...
extension Listener : RangeReplaceableCollection where T : RangeReplaceableCollection {
